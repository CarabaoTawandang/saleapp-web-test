<?//------------------------------------------------------------------web นี้สร้างโดย Numphung(น้ำผึ้ง) ปี2557
		...
		$txtSalecode = $_POST['txtSalecode'];  // เพิ่ม Salecode  27 Oct 2015
...
else
{
		...
		,COMPANYCODE,dc_groupid,RoleID_Lineid,Updatestatus,Car_plate,talet_no_imei,User_pic,phone_sim,phone,UserID_byAX,warehouse_locationNo,st_saletype,Salecode ,Pinter_no ) values
			('$CodeId','$txtUsername','$pwd','$txtName','$txtSurname','Y','$txtType','$USER_id','$USER_id',GETDATE(),GETDATE()
			,'$txt_COMPANY','$txtDC','$txtType2','1','$Car_plate','$txtimei','$img','$txtphone_sim','$txtphone','$txtAx','$st_warehouse_location','$txt_saletype','$txtSalecode','$txt_Mac')";
