  ...
  <div id="box">
      ...
      <div class="header">
        ...
        <h3>ค้นหาตำบล</h3>
          ...
          <p>รายชื่อตำบล
		  <input type="button" value="เพิ่มตำบล" id="btn_add" onclick="window.location='?page=add_district';" align="center" class="inner_position_right">
		  </p>
