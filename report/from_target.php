...
<div class="container_box">
  ...
  <div id="box">
      ...
      <div class="header">
        ...
        <h3>ค้นหาเป้ายอดขาย</h3>
            
          <p>รายชื่อเป้ายอดขาย
		  <input type="button" value="เพิ่มเป้ายอดขาย" id="btn_add" onclick="window.location='?page=add_target';" align="center" class="inner_position_right">
		  </p>
