...
<? 						
					...
					if($txt_receive){
									$sql2="  select st_unit_id,st_unit_name,P_Code from st_item_unit_con where P_Code ='$txt_receive' ";
								 if($txt_receive=='FG310102' ||$txt_receive=='FG9001001' ||$txt_receive=='FG9001002'||$txt_receive=='FG9001003') 
									{$sql2.=" and st_unit_id <>'ลัง'  ";  }
