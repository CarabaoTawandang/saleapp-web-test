...
<div class="container_box">
    <div id="box">
	<div class="header"><h3>บันทึกรับของเข้าคลัง</h3><!---หัวเรื่องหลัก-->
           <p>&nbsp;</p><!---หัวเรื่องรอง-->
...
<form  method="post" name="frmuser" id="frmuser" action="?page=save_receive_head" >
...
<tr><td><B>เลขที่D/O No.(PS)</B></td><td>
	<input type="text" id="txt_ref_pack" name="txt_ref_pack">
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td><B>ใบสั่งซื้อเลขที่ (PO)</B></td><td>
	<input type="text" id="txt_ref_docno" name="txt_ref_docno">
<tr><td colspan="2">&nbsp;</td></tr>
...
?>
				...
				<? 		$sql2="  select st_unit_id,st_unit_name,P_Code
						...
						?>
						<input  value="0" type="hidden" id="NumP_<?=$P_Code;?>_U_<?=$re2['st_unit_id']?>" name="NumP_<?=$P_Code;?>_U_<?=$re2['st_unit_id']?>" size="5">
...
<tr><td  ><B>หมายเหตุ</B></td><td >
	<input type="text" id="txt_receive_Remark" name="txt_receive_Remark" size="70">
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
