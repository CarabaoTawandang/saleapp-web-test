...
$(function(){	
		...
		$('#btn_search').click(function(){
					if(($('#txt_name').prop('value')=='')&&($('#txt_tel').prop('value')=='')&&(document.getElementById("txt_all").checked != true))
					{alert("โปรดใส่สิ่งที่ต้องการที่ต้องการ !");}
					else {
					$('#txt_search').html("<img src='images/89.gif'>");
					$.ajax({
						
						url:'report/data_company.php',
						type:'POST',
  ...
  <div id="box">
      ...
      <div class="header">
        ...
        <h3>ค้นหาบริษัท</h3>
          ...
          <p>รายชื่อข้อมูลบริษัท
		  <input type="button" value="เพิ่มบริษัท" id="btn_add" onclick="window.location='?page=add_company';" align="center" class="inner_position_right">
		  </p>
	...
	ชื่อบริษัท&nbsp;<input type="text" id="txt_name" name="txt_name">
	&nbsp;&nbsp;เบอร์โทร&nbsp;<input type="text" id="txt_tel" name="txt_tel">
