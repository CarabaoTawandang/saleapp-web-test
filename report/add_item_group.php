<?//-----------------------------------------------แก้ไข by pong 03/07/2015
		...
		$sqlOpen="select prd_grp_id,prd_grp_nm from st_item_group";
		$params = array();
  ...
  <div id="box">
      ...
      <div class="header">
        ...
        <h3>เพิ่มกลุ่มสินค้า</h3>
          ...
          <p>
		  <input type="button" value="ค้นหากลุ่มสินค้า" id="btn_add" onclick="window.location='?page=from_item';"  class="inner_position_right">
		  </p>
...
<form  method="post" name="frmuser" id="frmuser" action="?page=save_item_group" >
<table cellpadding="0" cellspacing="0"  border="0" align="center"  class="box" width="1124px">
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td width="150"><B>ชื่อกลุ่มสินค้า</B></td><td><input type="text" id="txtITEM" name="txtITEM" style="width:300px;" required/>
&nbsp;<B style="color:red;text-align:center;">*</B>
</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
 

<tr><td width="150"><B>หมายเหตุ</B></td><td><input type="text" id="txt_remark"align="center" name="txt_remark" style="width:300px;" ></td></tr>
