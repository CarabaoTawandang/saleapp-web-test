<?//-----------------------------------------------แก้ไข by pong 03/07/2015
		...
		$sqlOpen="select st_unit_id,st_unit_name from st_item_unit";
		$params = array();
...
<div class="container_box">
  ...
  <div id="box">
      ...
      <div class="header">
        ...
        <h3>เพิ่มหน่วยของสินค้า</h3>
            
          <p>
		  <input type="button" value="ค้นหาหน่วยของสินค้า" id="btn_add" onclick="window.location='?page=from_item';"  class="inner_position_right">
		  </p>
...
<form  method="post" name="frmuser" id="frmuser" action="?page=save_item_unit" >
<table cellpadding="0" cellspacing="0"  border="0" align="center"  class="box" width="1124px">
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td width="150"><B>ชื่อหน่วยของสินค้า</B></td><td><input type="text" id="unit" name="unit" required/>
