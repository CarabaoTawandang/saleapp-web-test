...
<tr><td colspan="2">
	...
	<td align="center">
		<a href="?page=save_cust_type_main&do=del&id=<?=$cust_type_id;?>" onclick="return confirm('คุณต้องการลบข้อมูลประเภทสินค้าและชื่อร้านค้า?');" >
...
from st_item_product left join st_item_type on st_item_product.prd_type_id = st_item_type.prd_type_id 
 ...
 { if($t%2==0){ $col2="#FFFFFF ";}else{$col2="#F0F0F0 ";}
  ...
  echo '<TD align="center">';
   echo "<a href=\"?page=edit_cust_type_sub&id=".$re3['P_Code']."\"  >";
   echo '<img src="./images/edit.gif" style="cursor:pointer" alt="Complete"></a>';
  echo '</TD>';
  echo '<TD align="center">'; 
   echo "<a href=\"?page=save_cust_type_sub&do=del&id=".$re3['P_Code']."\" onclick=\"return confirm('คุณต้องการลบข้อมูลสินค้านี้ใช่หรือไม่?');\" >";
