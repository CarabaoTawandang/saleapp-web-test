...
<div class="container_box">
	...
	<div class="header"><h3>แก้ไขหน่วย+สินค้า&nbsp;<?=$re['PRODUCTNAME'];?></h3><!---หัวเรื่องหลัก-->
		...
		<!---เนื้อหา-->
<form  method="post" name="frmuser" id="frmuser" action="?page=save_unit_con&do=edit" >
...
<tr><td width="150"><B>หน่วยสินค้า</td><td><input type="text" id="id_unit" name="id_unit"value="<?=$re1['st_unit_id']; ?>"  style="width:100px;" disabled></div></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>

<tr><td width="150"><B>จำนวน</B></td><td><input  id='count' name="count" type="text" value="<?=$re1['st_unit_qty']; ?>"style="width:100px;" onKeyUp="if(this.value*1!=this.value) this.value='' ;" required/>&nbsp;&nbsp;<?=$re['st_unit_id'];?></select>&nbsp;<B style="color:red;text-align:center;">*</B></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
