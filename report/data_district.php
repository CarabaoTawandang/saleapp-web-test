...
?>
	...
	<tr>
	<td align="center">รหัสตำบล</td>
	<td align="center">ชื่อตำบล</td><td align="center">ชื่ออำเภอ</td><td align="center">ชื่อจังหวัด</td><td align="center">แก้ไข</td><td align="center">ลบ</td></tr>
	...
	<td align="center"><?=$re['DISTRICT_CODE']; ?></td>
	<td align="left"><?=$re['DISTRICT_NAME']; ?></td>
	<td align="left"><?=$re['AMPHUR_NAME']; ?></td>
	<td align="left"><?=$re['PROVINCE_NAME']; ?></td>
	<TD align="center"><img src="./images/edit.gif" style="cursor:pointer" alt="Complete" onclick="window.location='?page=edit_district&id=<?=$re['DISTRICT_ID'];?>';" /></TD>
	<TD align="center"><!--<a href="?page=save_district&do=del&id=<?=$re['DISTRICT_ID']; ?>" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่?');" ><img src="./images/del.gif" style="cursor:pointer" alt="Complete"></a>--></TD>
	</tr>
	<? $r++;} ?>
	</table>