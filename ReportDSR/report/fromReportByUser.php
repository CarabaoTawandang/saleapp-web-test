...
<script type="text/javascript">
	$(function(){	
		...
		$('#btSearch').click(function(){
					...
					else if($('#txt_Sale').prop('value')==' ')
					{ alert("โปรดใส่พนักงานขายที่ต้องการค้นหา");
					}
...
<form  method="post" name="frmuser" id="frmuser"  action="report/ExcelReportByUser.php">
	...
	<div id='divShow' style='border:0px solid #000;text-align:center;' >
	  <table width="1120" border="0" align="center" cellpadding="3" cellspacing="0"  class="box">
	    <tr><td colspan="10" ><div class="h_head">ค้นหาใบสรุปยอดขายประจำวัน</div> </tr>
	    ...
	    <tr>
			...
			<td align="center"><b style="color:black;text-align:center;">ศูนย์</b>
				<select id="txt_DC" name="txt_DC"   style="width:150px;"><option value=" " > - Selete -</option>
			...
			<select id="txt_Sale" name="txt_Sale"   style="width:150px;"><option value=""> - Selete -</option></select>
