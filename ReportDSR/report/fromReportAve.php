...
<form  method="post" name="frmuser" id="frmuser"  action="report/ExcelReporAve.php">
	...
	<div id='divShow' style='border:0px solid #000;text-align:center;' >
	  <table width="1120" border="0" align="center" cellpadding="3" cellspacing="0"  class="box">
	    <tr><td colspan="10" ><div class="h_head">ค้นหารายงานสรุปยอดขายเฉลี่ย </div> </tr>
