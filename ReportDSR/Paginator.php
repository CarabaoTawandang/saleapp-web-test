...
class Paginator{
	...
	function paginate(){
		...
		$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate\" href=\"".$this->url_next.$prev_page."\">&laquo; Previous</a> ":"<span class=\"inactive\" href=\"".$this->url_next.$prev_page."\">&laquo; Previous</span> ";
			...
			for($i=1;$i<=$this->num_pages;$i++){
				$this->return .= ($i == $this->current_page) ? "<a class=\"current\" href=\"".$this->url_next.$i."\">$i</a> ":"<a class=\"paginate\" href=\"".$this->url_next.$i."\">$i</a> ";
			}
		}
